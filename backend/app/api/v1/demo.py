...
LANGUAGE_RESPONSES: dict[str, dict[str, str]] = {
    ...
    "kn": {
        ...
        "default": "ಕಿಸಾನ್ ಮಿತ್ರ AI ನಿಮ್ಮ ಕೃಷಿ ಪ್ರಶ್ನೆಗೆ ಸಹಾಯ ಮಾಡಲು ಸಿದ್ಧವಾಗಿದೆ."
    ...
    "hi": {
        ...
        "default": "किसान मित्र AI आपकी कृषि संबंधी सभी समस्याओं में सहायता के लिए उपलब्ध है।"
    ...
    "te": {
        ...
        "default": "కిసాన్ మిత్ర AI మీ వ్యవసాయ అవసరాలన్నింటికీ సహాయ పడుతుంది."
    ...
    "ta": {
        ...
        "default": "கிசான் மித்ரா AI உங்களின் அனைத்து விவசாய சந்தேகங்களுக்கும் உதவ தயாராக உள்ளது."
    ...
    "ml": {
        ...
        "default": "കിസാൻ മിത്ര AI കർഷകരുടെ എല്ലാ സംശയങ്ങൾക്കും ഉത്തരം നൽകാൻ സജ്ജമാണ്."
    ...
    "mr": {
        ...
        "default": "किसान मित्र AI आपल्या शेतीविषयक सर्व प्रश्नांची उत्तरे देण्यासाठी उपलब्ध आहे."
    ...
    "pa": {
        ...
        "default": "ਕਿਸਾਨ ਮਿੱਤਰ AI ਤੁਹਾਡੀਆਂ ਸਾਰੀਆਂ ਖੇਤੀ ਲੋੜਾਂ ਵਿੱਚ ਮਦਦ ਲਈ ਤਿਆਰ ਹੈ।"
    ...
    "gu": {
        ...
        "default": "કિસાન મિત્ર AI ખેડૂતોની તમામ સમસ્યાઓના ઉકેલ માટે તત્પર છે."
    ...
    "bn": {
        ...
        "default": "কিসান মিত্র AI আপনার প্রতিটি প্রশ্নের সহায়তায় নিয়োজিত।"
    ...
    "en": {
        ...
        "default": "Kisan Mitra AI is ready to assist you with crop advisory, market prices, government schemes, and weather updates."
