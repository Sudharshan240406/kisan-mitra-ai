...
logger = logging.getLogger("kisan_mitra_ai.sms.fallback_provider")


class FallbackProvider:
    """Local fallback SMS provider that logs messages locally."""
    ...
    async def send_sms(self, recipient: str, body: str) -> bool:
        ...
        logger.info(f"[FallbackProvider] Sent SMS to {recipient}: {body}")
