...
export function KpiCard({ kpi, index }: { kpi: Kpi; index: number }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{ y: -3 }}
      className="glass-panel group relative overflow-hidden rounded-2xl p-5 transition-shadow hover:shadow-[0_20px_60px_-20px_oklch(0_0_0/50%)] z-10"
    >
      <div
      ...
      <div className="mt-1 flex items-baseline gap-1 font-display text-2xl font-bold tabular-nums text-white">
        {kpi.prefix}
        <span>{fmt(value)}</span>
